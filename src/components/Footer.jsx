            ...
            <div style={{ display: 'flex', alignItems: 'center', height: '100%' }}>
              <div style={{ 
                ...
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
                  <path d="M3 20.5V3.5C3 2.91 3.34 2.39 3.84 2.15L13.69 12L3.84 21.85C3.34 21.6 3 21.09 3 20.5Z" fill="#00C853"/>
                  <path d="M16.81 15.12L6.05 21.34L14.54 12.85L16.81 15.12Z" fill="#4285F4"/>
                  <path d="M6.05 2.66L16.81 8.88L14.54 11.15L6.05 2.66Z" fill="#FFC107"/>
...
function Footer() {
  ...
  const handleNewsletterSubmit = (e) => {
    ...
    // You can add API call here to submit the email
          ...
          <div className="container mil-p-120-60" style={{ padding: '80px 40px' }}>
            ...
            <div className="row mil-mb-90 mil-newsletter-row justify-content-center">
              <div className="col-lg-6 col-md-8 col-12 mil-mb-60 text-center">
                <p className="mil-light-soft mil-up mil-mb-30" style={{ 
                  ...
                  color: '#ffffff',
                  fontSize: '16px'
                }}>Subscribe for News and Information</p>
            ...
            <div className="row justify-content-center text-center mil-mb-60" style={{ rowGap: '30px' }}>
              <div className="col-md-4 mil-mb-40">
                <h6 className="mil-muted mil-up mil-mb-20" style={{ 
                  color: '#ffffff',
                  fontSize: '18px',
                  fontWeight: '600',
                  marginBottom: '15px'
                }}>Dubai - U.A.E.</h6>
                <p className="mil-light-soft mil-up" style={{ 
                  color: '#ffffff',
                  fontSize: '15px',
                  lineHeight: '1.8'
                }}>
              ...
              <div className="col-md-4 mil-mb-40">
                ...
                <p className="mil-light-soft mil-up" style={{ 
                  ...
                  <br />
                  <a href="mailto:info@wishgroup.ae" style={{ color: '#ffffff', textDecoration: 'none' }}>info@wishgroup.ae</a>
                  <br />
                  <a href="mailto:info@wishgroup.world" style={{ color: '#ffffff', textDecoration: 'none' }}>info@wishgroup.world</a>
                </p>
              </div>
              <div className="col-md-4 mil-mb-40" style={{ display: 'flex', justifyContent: 'center' }}>
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '12px' }}>
                  <h6 className="mil-muted mil-up" style={{ 
                    margin: 0, 
                    textAlign: 'center', 
                    whiteSpace: 'nowrap',
                    color: '#ffffff',
                  ...
                  <ul className="mil-social-icons mil-up" style={{ 
                    listStyle: 'none',
                    padding: 0,
                    margin: 0,
                    display: 'flex',
                    ...
                    <li>
                      <a href="https://www.linkedin.com/company/wish-group" target="_blank" rel="noopener noreferrer" style={{
                        color: '#ffffff',
                        fontSize: '20px',
                        textDecoration: 'none',
                    ...
                    <li>
                      <a href="https://www.facebook.com/wishgroup" target="_blank" rel="noopener noreferrer" style={{
                        color: '#ffffff',
                        fontSize: '20px',
                        textDecoration: 'none',
                        transition: 'opacity 0.3s'
                    ...
                    <li>
                      <a href="https://twitter.com/wishgroup" target="_blank" rel="noopener noreferrer" style={{
                        color: '#ffffff',
                        fontSize: '20px',
                        textDecoration: 'none',
                        transition: 'opacity 0.3s'
                    ...
                    <li>
                      <a href="https://www.instagram.com/wishgroup" target="_blank" rel="noopener noreferrer" style={{
                        color: '#ffffff',
                        fontSize: '20px',
                        textDecoration: 'none',
                        transition: 'opacity 0.3s'
            ...
            <div className="row">
              <div className="col-12">
                ...
                <p className="mil-light-soft mil-up mil-text-center" style={{ 
                  color: '#ffffff',
                  fontSize: '14px',
                  margin: 0
                }}>© Copyright 2025 - Wish Group. All Rights Reserved.</p>
              </div>
            </div>
          </div>
        </div>
